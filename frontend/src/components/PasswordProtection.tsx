...
const PasswordProtection: React.FC<PasswordProtectionProps> = ({
    ...
    return (
        <div className="min-h-screen bg-[var(--sidebar-bg)] flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-md bg-card border border-border rounded-md p-10 shadow-2xl animate-in zoom-in-95 duration-500">
                <div className="text-center mb-10">
                    <div className="inline-flex p-5 rounded-md bg-emerald-500/10 text-emerald-500 mb-6 ring-1 ring-emerald-500/20">
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    <Input
                        ...
                        placeholder="••••••••"
                        className="h-14 bg-background border-border rounded-md text-center text-xl tracking-widest font-mono"
                        autoFocus
                    />
                    ...
                    <Button
                        ...
                        className="w-full h-14 rounded-md premium-gradient text-white shadow-premium text-xs font-black uppercase tracking-[0.2em]"
                    >
