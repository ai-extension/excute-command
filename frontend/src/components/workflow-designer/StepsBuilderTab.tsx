...
import { Layers, Plus, GripVertical, AlertCircle, Server, SlidersHorizontal, File, Trash2, RefreshCw, FileText, Terminal, Copy, Check, CheckCircle2, XCircle, Info } from 'lucide-react';
                                ...
                                try {
                                    ...
                                    for (let i = 0; i < tokens.length; i++) {
                                        ...
                                        if (token === '-X' || token === '--request') {
                                            if (i + 1 < tokens.length) method = tokens[++i].replace(/^"|"$/g, '').replace(/^'|'$/g, '').toUpperCase();
                                        }
