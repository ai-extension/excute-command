            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 space-y-4 border-t border-border/50 pt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-card p-6 rounded-md border border-border flex items-center justify-between">
                            <div className="space-y-1 w-3/4">
                                <h3 className="text-xs font-black uppercase tracking-widest text-primary">Library Template</h3>
                        ...
                        <div className={cn(
                            "p-6 rounded-md border transition-all duration-300 flex items-center justify-between",
                            isPublic
