...
import { Plus, Search, ChevronRight, Server as ServerIcon, Shield, Key, Terminal, MoreHorizontal, Settings, Trash2, Edit2, Play, CheckCircle2, XCircle } from 'lucide-react';
import {
    Table,
    TableBody,
    TableCell,
